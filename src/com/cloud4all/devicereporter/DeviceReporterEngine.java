...
public class DeviceReporterEngine {
	...
	// Constructor
	public DeviceReporterEngine(Context context) {
		getDataAboutDevice();
		getDataAboutOperatingSystem(context);
		getDataAboutHardware(context);
		getDataAboutSensors(context);
		getDataAboutSound(context);
		getDataAboutScreen(context);
	}
